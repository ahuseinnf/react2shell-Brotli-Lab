...
echo "Creating Brotli proxy route handler with Node.js runtime..."

# Create the API route directory
mkdir -p app/api/rsc

# Create the route handler with Node.js runtime
cat > app/api/rsc/route.ts << 'EOF'
...
echo "✓ Created app/api/rsc/route.ts with Node.js runtime"
echo ""
echo "Now delete middleware.ts:"
echo "  rm middleware.ts"
echo ""
echo "Then update brotli-waf-bypass.py endpoint to:"
echo "  ENDPOINT = 'http://localhost:3000/api/rsc'"
echo ""
